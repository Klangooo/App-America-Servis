...
const api = axios.create({
  ...
  gravarFim = async () => {
    ...
    try{
      ...
      Keyboard.dismiss();
      Alert.alert("Sucesso!", "O seu fim de expediente foi salvo com sucesso!");
    } catch (e) {
      Alert.alert("Erro ao salvar", "")
    }
  ...
  return (
    ...
    {this.state.showButton && this.state.ready && <TouchableOpacity 
     ...
     {this.state.showButton && this.state.ready && <TouchableOpacity 
      ...
      {this.state.showButton && this.state.ready && <TouchableOpacity 
          style = {styles.button}
          onPress = { this.createPonto }>
        <Text style = {styles.buttonText}>Finalizar expediente coletivo</Text>
      </TouchableOpacity>}
